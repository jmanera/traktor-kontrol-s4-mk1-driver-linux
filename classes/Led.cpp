...
map<int, Led *> Led::leds_mapping = {
        ...
        { 2, new Led(2, "HEADPHONE INDICATOR", Led::OFF, false) },
        {3, new Led(3, "MASTER INDICATOR", Led::OFF, false)},
        {4, new Led(4, "SNAP INDICATOR", Led::OFF, false)},
        {5, new Led(5, "WARNING INDICATOR", Led::OFF, false)},
        ...
        {34, new Led(34, "CH2 VOL METER 6", Led::OFF, false)},
        {35, new Led(35, "CH2 VOL METER CLIP", Led::OFF, false)},
